...
<li class="pcoded-hasmenu">
    ...
    <?php if(($_SESSION['user'] == 'doctor')) { ?>
        <li class="">
            <a href="view-pending-appointment1.php">
                <span class="pcoded-mtext">View Pending Appointments</span>
            </a>
        </li>
        <li class="">
            <a href="view-appointments-approved1.php">
                <span class="pcoded-mtext">View Approved Appointments</span>
            </a>
        </li>
    <?php } ?>
...
<li class="pcoded-hasmenu">
    ...
    <?php if($_SESSION['user'] == 'admin') { ?>
        ...
        <li class="">
            <a href="view-patient-inactive.php">
                <span class="pcoded-mtext">View Patients Inactive</span>
            </a>
        </li>
    <?php } ?>
        <li class="">
    ...
    <ul class="pcoded-submenu">
        ...
        <li class="">
            <a href="view-Event.php">
                <span class="pcoded-mtext">View Event</span>
            </a>
        </li>
    </ul>
</li>
