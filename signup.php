...
<image class="profile-img" src="uploadImage" style="width: 50%"></image>
</div>
...
<div class="col-sm-6">
<div class="form-group form-primary">
<input type="checkbox" name="confirm-password" class="form-control" required="">
<span class="text-inverse">Male</span>
<span class="form-bar"></span>

<input type="checkbox" name="confirm-password" class="form-control" required="">
<span class="text-inverse">Famelle</span>
<span class="form-bar"></span>
</div>
</div>
</div>
