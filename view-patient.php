...
<?php
  ...
  $sql1="SELECT * FROM appointment " ;
    ...
    while ($rsedit1 = mysqli_fetch_array($qsql1)){
      $sql ="SELECT * FROM patient where patientid= {$rsedit1['patientid']} AND delete_status='0'";
      $qsql = mysqli_query($conn,$sql);
...
<?php
  ...
  $sql1 = "SELECT * FROM appointment WHERE doctorid = '".$_SESSION["doctorid"]."'" ;
    $qsql1 = mysqli_query($conn,$sql1);
    while ($rsedit1 = mysqli_fetch_array($qsql1)){
      $sql ="SELECT * FROM patient where patientid= {$rsedit1['patientid']} AND delete_status='0'";
      $qsql = mysqli_query($conn,$sql);
