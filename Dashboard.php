...
<?php if($_SESSION['user'] == 'admin'){ ?>
    <div class="row">
      <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-block">
                <div class="ct-chart1 ct-perfect-fourth" style="width: 550px; height: 400px; padding-bottom: 50%; "></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-block">
                <div class="ct-chart1-patient ct-perfect-fourth" style="width: 550px; height: 400px; padding-bottom: 50%; "></div>
            </div>
        </div>
    </div>
  </div>
